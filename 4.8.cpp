...
void Deposit(vector<string> &names,vector<float> &balances,string key){
    int N = names.size();
    int deposit;
    cout << "---------------------------------\n\n";
    for(int i = 0 ; i < N ; i++){
    ...
    cout <<"How much will you deposit? ";
            ...
            status = "add";
            write(sname,deposit,status,balances[m]);
...
void Withdraw(vector<string> &names,vector<float> &balances,string key){
    int N = names.size();
    int withdraw;
    cout << "---------------------------------\n\n";
    for(int i = 0 ; i < N ; i++){
    ...
    cout <<"How much will you withdraw? ";
            ...
            cout << sname << "'s balance = " << fixed << setprecision(2) << balances[m] << endl;
            status = "withdraw";}
            write(sname,withdraw,status,balances[m]);
...
void Transfer(vector<string> &names,vector<float> &balances,string key){
	int N = names.size();
    int transfer,t=0;
    ...
    cout <<"How much will you transfer? ";
            ...
            cout << sname << "'s balance = " << fixed << setprecision(2) << balances[m] << endl;
            status = "withdraw";}
            write(sname,transfer,status,balances[m]);
            balances[t] += transfer;
            status = "deposit";
            write(tname,transfer,status,balances[t]);
    cout << "\n\n---------------------------------";
...
int main(){
	...
	while(true){
        ...
        if(x == 1) Deposit(names, balances, key);
		if(x == 2) Withdraw(names, balances, key);
		if(x == 3) Transfer(names, balances, key);
